            ...
            <div class="card border-0 shadow-sm rounded-4">
                <div class="card-body p-4">
                    <div class="d-flex justify-content-between align-items-center mb-4">
                        <h4 class="card-title fw-bold">Edit Room</h4>
                    ...
                    <form action="<?php echo URLROOT; ?>/rooms/edit/<?php echo $data['id']; ?>" method="post">
                        ...
                        <div class="alert alert-warning small">
                            <i class="fas fa-exclamation-circle me-1"></i> Warning: Changing dimensions of a room that
                            already has active showtimes/bookings may cause seat mapping issues.
                        </div>

                        <div class="d-grid mt-4">
                            <button type="submit" class="btn btn-primary rounded-pill fw-bold py-2">Update Room</button>
                        </div>
                    </form>
                </div>
            </div>
